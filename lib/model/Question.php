...
class Question extends WildfireCustomField{
  ...
  public function setup(){
    ...
    $this->define("extra_class", "CharField", array('widget'=>'SelectInput', 'choices'=>array(''=>'None', 'large'=>'large', 'xlarge'=>'extra large', 'stacked'=>'force stacked', 'repeating'=>'repeating', 'stackable'=>'stackable repeating')));
