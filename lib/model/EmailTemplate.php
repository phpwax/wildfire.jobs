...
class EmailTemplate extends WaxModel{
  ...
  public function setup(){
    ...
    $this->define("pdf_view", "CharField", array('label'=>'Custom PDF','choices'=>self::pdf_view_choices(), 'widget'=>'SelectInput' ));
  }
  ...
  public static function pdf_view_choices(){
    $data = array(''=>'-- select --');
    foreach(glob(VIEW_DIR."admin/extras/-*.print") as $f){
      $base = basename($f, ".print");
      $data[$base] = Inflections::humanize($base);
    }
    return $data;
  }
